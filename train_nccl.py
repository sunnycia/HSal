...
# caffe_path = '/data/sunnycia/hdr_works/source_code/hdr_saliency/training/caffe/python'
# cmd = 'export PYTHONPATH="%s:$PYTHONPATH"' % caffe_path
# print cmd
# os.system(cmd)
# salicon_api_path = '/data/sunnycia/hdr_works/source_code/hdr_saliency/training/salicon-evaluation/'
# salicon_eval_path = '/data/sunnycia/hdr_works/source_code/hdr_saliency/training/salicon-evaluation/saliconeval'
# sys.path.insert(1, salicon_api_path)
# sys.path.insert(1, salicon_eval_path)
# #import salicon API
...
# def do_validation(mapdir, jsondir, jsonname, db, im_means, datum, solver, rst_blob_names, map_name, ):
#     pass

# def do_mit_validation():
#     pass
